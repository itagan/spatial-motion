...
const cases: Array<{ config: LayoutConfig; direct: Layout }> = [
  {
    config: { version: 1, type: 'sphere', options: { radius: 6, rings: 12, stagger: true, density: 0.7, orientation: 'surface' } },
    direct: sphere({ radius: 6, rings: 12, stagger: true, density: 0.7, orientation: 'surface' }),
  },
  {
    config: { version: 1, type: 'box', options: { width: 9, height: 7, depth: 5, density: 0.75, orientation: 'camera' } },
    direct: box({ width: 9, height: 7, depth: 5, density: 0.75, orientation: 'camera' }),
  },
  {
    config: { version: 1, type: 'cylinder', options: { radius: 4, spacing: 0.7, columns: 24 } },
    direct: cylinder({ radius: 4, spacing: 0.7, columns: 24 }),
  },
  {
  ...
  {
    config: { version: 1, type: 'ring', options: { innerRadius: 1, spacing: 0.5, rings: 6, startAngle: 0.4, orientation: 'tangent', density: 0.75 } },
    direct: ring({ innerRadius: 1, spacing: 0.5, rings: 6, startAngle: 0.4, orientation: 'tangent', density: 0.75 }),
  },
  {
  ...
  {
    config: { version: 1, type: 'cone', options: { radius: 4, height: 8, rings: 10, startAngle: 0.3, stagger: true, orientation: 'surface', density: 0.72 } },
    direct: cone({ radius: 4, height: 8, rings: 10, startAngle: 0.3, stagger: true, orientation: 'surface', density: 0.72 }),
  },
  {
